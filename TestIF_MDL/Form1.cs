    ...
    public partial class Form1 : Form
    {
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                {
                    //richTextBox1.LoadFile(openFileDialog1.FileName, RichTextBoxStreamType.PlainText);
                    //REG.rtf_text(richTextBox1.Text, 2);

                    {
                        ...
                        IntPtr pBSTR = SysAllocStringByteLen(null, (UInt32)(buff.Length) + 1);
                        uint size = SysStringByteLen(pBSTR);
                ...
                {
                    System.Windows.Forms.MessageBox.Show("Error", "", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                }
                showReg(treeView2.Nodes, REG.ParserString);
                treeView2.ExpandAll();
                showReg(treeView3.Nodes, REG.PatternString);
