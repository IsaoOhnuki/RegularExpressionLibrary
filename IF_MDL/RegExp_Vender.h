...
public:
	...
	{
		return std::pair<target_iterator, target_iterator>((target_iterator)&*fupper_char.begin(), (target_iterator)&*fupper_char.end());
	}
	template<typename target_iterator>
	...
	{
		return std::pair<mem_container::const_iterator, mem_container::const_iterator>(fupper_char.begin(), fupper_char.end());
	}
	template<>
